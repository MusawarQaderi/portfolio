...
export const PROJECTS = [
  ...
  { title: 'Linux System Administration — Server-Setup', image: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80', description: 'Grundlagen der Linux-Systemverwaltung mit Fokus auf Server-Setup, Benutzer- und Dateiverwaltung sowie Sicherheit. Praktische Anwendung von Bash-Scripting für Automatisierung.', technologies: ['Linux', 'Bash', 'System Administration', 'Server Setup'], category: 'devops', githubLink: 'https://github.com/MusawarQaderi', websiteLink: '', },
];
export const CONTACT = {
  address: 'Hamburg, Deutschland',
  phoneNo: '+49 176 32293201',
...
export const PROJECTS_BY_CATEGORY = {
  ...
  development: PROJECTS.filter(project => project.category === 'development'),
};